...
namespace Maticsoft.DBUtility
{
    ...
    public class DbHelperSQLP
    {
        ...
        /// <param name="parameters">存储过程参数</param>
        /// <returns>SqlDataReader</returns>
        public DataSet RunProcedureAdditional(string storedProcName, IDataParameter[] parameters)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        /// <returns>DataSet</returns>
        public DataSet RunProcedureAdditional(string storedProcName, IDataParameter[] parameters, ref int rowsCount)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                DataSet dataSet = new DataSet();
        ...
        public void SqlDataTableCopy(DataTable dt, string tableName, Hashtable ht)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
        ...
        /// <param name="dt">记录集</param>
        /// <param name="tableName">表名</param>
        public void SqlDataTableCopy(DataTable dt, string tableName)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                connection.Open();
